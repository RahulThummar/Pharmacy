...
function addCustomer() {
  ...
  if(!validateName(customer_name.value, "name_error"))
    ...
    var xhttp = new XMLHttpRequest();
  	...
  	xhttp.open("GET", "php/add_new_customer.php?name=" + customer_name.value + "&contact_number=" + contact_number.value + "&address=" +
     customer_address.value + "&doctor_name=" + doctor_name.value + "&doctor_address=" + doctor_address.value, true);
  	xhttp.send();
  }
  return false;
}
