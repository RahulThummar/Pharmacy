...
.myDiv {
 ...
 <div class="myDiv">
  <h1><span style="color: #F2AA4CFF"><b>H</b></span>arikrushna <span style="color: #F2AA4CFF"><b>P</b></span>harma  
</div>
    <div class="container">
      <div class="card m-auto p-2">
        <div class="card-body">
          <form name="login-form" class="login-form" action="home.php" method="post" onsubmit="return validateCredentials();">
            <div class="logo">
        			<img src="images/hp.png" height="80px" width="80px"   class="profile"/>
