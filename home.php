...
<html lang="en" dir="ltr">
  <head>
    ...
    <link rel="shortcut icon" href="images/	on.svg" type="image/x-icon">
  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col col-xs-4 col-sm-4 col-md-4 col-lg-4" style="padding: 7px 0; margin-left: 15px;">
			...
			<div class="shadow">
              ...
              <div class="h5"><span style="color:#F2AA4CFF">Dailly Report </span></div>
        ...
        <hr style="border-top: 1px outset steelblue;">
